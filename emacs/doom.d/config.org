...
* ivy
1. [[https://www.wisdomandwonder.com/article/10795/emacsorg-mode-migrate-from-ido-to-ivy-in-one-quick-step][(Emacs+Org-Mode) Migrate From Ido To Ivy In One Quick Step]]
2. [[https://emacs.stackexchange.com/questions/36745/enable-ivy-fuzzy-matching-everywhere-except-in-swiper][Enable ivy fuzzy matching everywhere, except in swiper]]
...
** org agenda
org agenda里面时间块彩色显示。[[https://emacs-china.org/t/org-agenda/8679/3][Org agenda 显示时间块]]
...
example: `aa-bb-cc.org' then save image test.png to `aa-bb-cc/test.png'.
